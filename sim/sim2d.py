...
def sim_run(options, KalmanFilter):
    ...
    light2, = ax.plot([90, 94], [94, 94], 'r-', linewidth=3)
    ...
    # First section.
    ax.plot([1, 1], [9, 1], 'k-')
    ax.plot([1, 87], [9, 9], 'k-') #üst çizgi
    ax.plot([1, 85], [5, 5], 'k--') #orta şerit
    ax.plot([1, 95], [1, 1], 'k-')  #alt çizgi
    ax.plot([87, 87], [9, 0], 'k--') #yolun sonu
